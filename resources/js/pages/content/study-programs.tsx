...
export default function StudyPrograms({ page }: Props) {
    return (
        <>
                    ...
                    <div className="container mx-auto px-4 py-4">
                        <nav className="flex items-center justify-between">
                            ...
                            <div className="hidden md:flex items-center space-x-6">
                                ...
                                <Link href={route('content.study-programs')} className="text-green-700 hover:text-green-900 font-medium">Program Studi</Link>
                            </div>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="text-xl text-gray-600">
                                    Program studi berkualitas dengan kurikulum terdepan
                                </p>
                            </div>
