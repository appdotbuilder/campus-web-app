 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\StudyTracer> $studyTracers
 * 
...
class User extends Authenticatable
{
    ...
    /**
     * Get the study tracers submitted by this user.
     */
    public function studyTracers(): HasMany
    {
        return $this->hasMany(StudyTracer::class);
    }
